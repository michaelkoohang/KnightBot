...
audio_path = "input.wav" #File recorded to
input_audio_file = "input.wav"
output_audio_file = "output.wav"
lang = "en-US"
model = ["Knightbot.pmdl"] #snowboy model file. It is in a list because Snowboy is used to accepting arguments from the command line and compiling them into a list.
